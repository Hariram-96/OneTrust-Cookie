    ...
    <div className="privacy-page">
      <div className="privacy-container">
        <div className="privacy-card">
          ...
          <section className="privacy-section">
            <div>
              ...
              <p>
                Startup AI India (“we”, “our”, “us”) respects your privacy
            ...
            <div>
              ...
              <p>
                ...
                <br />
                <strong>Startup AI India</strong> <br />
                1234 AI Street <br />
                privacy@startupaiindia.com <br />
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                <a href="mailto:privacy@startupaiindia.com">
                  privacy@startupaiindia.com
                </a>
                .
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                <br />
                <strong>Address:</strong> Chennai - 600100, Tamil Nadu, India
              </p>
            </div>
          </section>
        </div>
        ...
        <footer className="privacy-footer">
          © {new Date().getFullYear()} Startup AI India. All rights reserved.
        </footer>
      </div>
    </div>
  );
